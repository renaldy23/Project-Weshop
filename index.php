...
<html>
	<head>
			...
			<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL. "ss/style.css"; ?>">
			<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL. "css/fontawesome-free-5.13.1-web/css/all.min.css"; ?>">
			...
			<div id="container">
				<div id="header">
					...
					<div id="menu">
						...
						<a href="<?php echo BASE_URL."keranjang.html"; ?>" id="cart">
							<img src="<?php echo BASE_URL."img/cart.png"; ?>" >
							<?php
								echo "<span id='total-barang'>$totalBarang</span>";
							?>
						</a>
					</div>
				</div>
